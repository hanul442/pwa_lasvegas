import { buildBankruptcyComparisonCard } from './bankruptcy-cards.mjs';
...
function bankruptcyMoment(state, bankruptcy) {
  ...
  const comparisonCard = buildBankruptcyComparisonCard(bankruptcy);
  ...
  return {
    ...
    comparisonCardAvailable: Boolean(comparisonCard),
...
export function buildSocialMomentsSnapshot(state, viewerId, { limit = 20 } = {}) {
  ...
  return {
    ...
    policy: {
      ...
      bankruptcyComparisonCards: true,
      comparisonCardSemantics: 'ILLUSTRATIVE_SCALE_ONLY',
